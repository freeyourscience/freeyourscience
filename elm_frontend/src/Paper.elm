module Paper exposing (FreePathwayPaper, NoCostOaPathway, OtherPathwayPaper, Paper, PolicyMetaData, parsePolicies, toPaper)

import BackendPaper exposing (BackendEmbargo, BackendLocation, BackendPaper, BackendPermittedOA, BackendPolicy, BackendPrerequisites)
